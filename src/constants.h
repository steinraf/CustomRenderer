...
namespace customRenderer{
    ...
    [[nodiscard]] __device__ __host__ static constexpr float getCameraAperture() noexcept{ return 1.0f; }

    [[nodiscard]] __device__ __host__ static constexpr int getNumSubsamples() noexcept{ return 16; }
